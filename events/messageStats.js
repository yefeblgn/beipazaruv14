...
const guildChannel = require("../schemas/messageGuildChannelsSchema");
const userChannel = require("../schemas/messageChannelsSchema");
...
message.reply({content:`> **💎 Elmas Chat Seviyesine Ulaştın!**`})
	...
	if (config.taskSystem && config.staffs.some((x) => message.member.roles.cache.has(x))) {
