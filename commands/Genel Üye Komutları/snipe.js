...
module.exports = {
    ...
    execute: async (client, message, args, embed) => {
     ...
     if(!data) return message.reply({ embeds: [embed.setDescription(`> **Bu Kanalda Silinen Bir Mesaj Bulunmamakta!**`)] }).sil(5);
     client.true(message)
     return message.channel.send({ embeds: [embed.addFields(
